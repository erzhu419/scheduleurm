...
|---|---|---|---|---|---:|---:|---:|---|
| `gpu_node007_4x11gb|q11_high_cpu_high_gpu|hybrid_rl_resac_hopper|hopper|empty|none` | `node007-direct` | `hybrid_rl_resac_hopper` | `hopper` | `empty` | `[4]` | false | `[4]` | `p4=1.29289` |
