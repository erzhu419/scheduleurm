...
|---|---|---|---|---|---:|---:|---:|---|
| `gpu_3080ti_12gb_dual|q11_high_cpu_high_gpu|hybrid_rl_bapr_ant|bapr_ant|full_loaded|same_workload_to_capacity_boundary` | `jtl110gpu2` | `hybrid_rl_bapr_ant` | `bapr_ant` | `full_loaded` | `[4]` | true | `[]` | `p4=0.607942` |
