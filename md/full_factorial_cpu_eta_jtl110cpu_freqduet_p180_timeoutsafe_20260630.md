...
|---|---|---|---|---|---:|---:|---|
| `cpu_jtl110_128c|q10_high_cpu_low_gpu|freqduet_cpu_ablation_c17_32|freqduet|empty|none` | `jtl110cpu` | `freqduet_cpu_ablation_c17_32` | `freqduet` | `empty` | `[180]` | true | `p180=5.69436` |
