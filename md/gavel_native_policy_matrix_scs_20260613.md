...
|---|---:|
| `pass` | true |
| `usable_native_performance_sample_count` | 12 |
...
| `q01_gpu_bound_compute` | `isolated` | 4 | `PASS` | 4 | 25.464 | 25.464 | 1 | true |
| `q01_gpu_bound_compute` | `max_min_fairness` | 4 | `PASS` | 4 | 25.464 | 25.464 | 1 | true |
| `q01_gpu_bound_compute` | `finish_time_fairness` | 4 | `PASS` | 4 | 25.464 | 25.464 | 1 | true |
| `q01_gpu_bound_compute` | `min_total_duration` | 4 | `PASS` | 4 | 25.464 | 25.464 | 1 | true |
| `q01_gpu_bound_compute` | `max_sum_throughput_perf` | 4 | `PASS` | 4 | 25.464 | 25.464 | 1 | true |
| `q11_cpu_gpu_coupled` | `fifo` | 8 | `PASS` | 8 | 11.149 | 11.149 | 1 | true |
| `q11_cpu_gpu_coupled` | `isolated` | 8 | `PASS` | 8 | 11.149 | 11.149 | 1 | true |
| `q11_cpu_gpu_coupled` | `max_min_fairness` | 8 | `PASS` | 8 | 11.149 | 11.149 | 1 | true |
| `q11_cpu_gpu_coupled` | `finish_time_fairness` | 8 | `PASS` | 8 | 11.149 | 11.149 | 1 | true |
| `q11_cpu_gpu_coupled` | `min_total_duration` | 8 | `PASS` | 8 | 11.149 | 11.149 | 1 | true |
| `q11_cpu_gpu_coupled` | `max_sum_throughput_perf` | 8 | `PASS` | 8 | 11.149 | 11.149 | 1 | true |
