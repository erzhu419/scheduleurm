...
|---|---|---:|---:|---:|:---:|
| `cnn_after_llm` | `gpu_llm_distilgpt2` -> `gpu_cnn_torch_resnet50` | 10.5104 | 198.065 | 5.70866 | true |
| `cnn_after_rl` | `hybrid_rl_resac_ant` -> `gpu_cnn_torch_resnet50` | 11.4816 | 0.0843783 | 5.22575 | true |
| `llm_after_cnn` | `gpu_cnn_torch_resnet50` -> `gpu_llm_distilgpt2` | 11.0345 | 24.4561 | 10.875 | true |
| `rl_after_cnn` | `gpu_cnn_torch_resnet50` -> `hybrid_rl_resac_ant` | 875.925 | 18.2455 | 0.045666 | true |
