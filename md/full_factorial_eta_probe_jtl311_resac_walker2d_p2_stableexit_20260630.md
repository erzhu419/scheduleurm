...
|---|---|---|---|---|---:|---:|---:|---|
| `gpu_rtx2080_8gb_dual_cpu_fast|q11_high_cpu_high_gpu|hybrid_rl_resac_walker2d|walker2d|empty|none` | `jtl311linux` | `hybrid_rl_resac_walker2d` | `walker2d` | `empty` | `[2]` | true | `[]` | `p2=0.783573` |
