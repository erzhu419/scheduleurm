...
- Selected rows: `2`
- Max rows per lane: `4`
- Availability audit: `md/experiment_artifacts/resource_audit_all_recheck_20260701/corner_case_resource_audit.json`
...
| `gpu_jtl110_spillover` | `jtl110gpu2` | `jtl110gpu2:gpu` | 2 | 2 |
...
|---|---|---|---|---|---|
| `gpu_jtl110_spillover` | `hybrid_rl_bapr_ant` | `jtl110gpu2` | `full_loaded` | `4` | `python3 -m algorithm.experiments.full_factorial_eta_probe_runner --allow-launch --design-csv md/experiment_artifacts/full_factorial_parallel_assignments_replan_avail_20260701/ff_parallel_eta_replan_avail_20260701_gpu_jtl110_spillover_gpu_3080ti_12gb_dual_q11_high_cpu_high_gpu_hybrid_rl_bapr_ant_bapr_ant_full_loaded_same_workload_to_capacity_boundary.csv --tier T0_core_curve --resource-state full_loaded --nodes jtl110gpu2 --workloads hybrid_rl_bapr_ant --max-rows 1 --run-prefix ff_parallel_eta_replan_avail_20260701_gpu_jtl110_spillover_jtl110gpu2_full_loaded_hybrid_rl_bapr_ant --output md/experiment_artifacts/full_factorial_parallel_probe_ff_parallel_eta_replan_avail_20260701_gpu_jtl110_spillover_jtl110gpu2_full_loaded_hybrid_rl_bapr_ant.json --cache-output md/experiment_artifacts/service_cache_v2_full_factorial_parallel_probe_ff_parallel_eta_replan_avail_20260701_gpu_jtl110_spillover_jtl110gpu2_full_loaded_hybrid_rl_bapr_ant.json --markdown-output md/full_factorial_parallel_probe_ff_parallel_eta_replan_avail_20260701_gpu_jtl110_spillover_jtl110gpu2_full_loaded_hybrid_rl_bapr_ant.md` |
| `gpu_jtl110_spillover` | `hybrid_rl_resac_ant` | `jtl110gpu2` | `full_loaded` | `6` | `python3 -m algorithm.experiments.full_factorial_eta_probe_runner --allow-launch --design-csv md/experiment_artifacts/full_factorial_parallel_assignments_replan_avail_20260701/ff_parallel_eta_replan_avail_20260701_gpu_jtl110_spillover_gpu_3080ti_12gb_dual_q11_high_cpu_high_gpu_hybrid_rl_resac_ant_ant_full_loaded_same_workload_to_capacity_boundary.csv --tier T0_core_curve --resource-state full_loaded --nodes jtl110gpu2 --workloads hybrid_rl_resac_ant --max-rows 1 --run-prefix ff_parallel_eta_replan_avail_20260701_gpu_jtl110_spillover_jtl110gpu2_full_loaded_hybrid_rl_resac_ant --output md/experiment_artifacts/full_factorial_parallel_probe_ff_parallel_eta_replan_avail_20260701_gpu_jtl110_spillover_jtl110gpu2_full_loaded_hybrid_rl_resac_ant.json --cache-output md/experiment_artifacts/service_cache_v2_full_factorial_parallel_probe_ff_parallel_eta_replan_avail_20260701_gpu_jtl110_spillover_jtl110gpu2_full_loaded_hybrid_rl_resac_ant.json --markdown-output md/full_factorial_parallel_probe_ff_parallel_eta_replan_avail_20260701_gpu_jtl110_spillover_jtl110gpu2_full_loaded_hybrid_rl_resac_ant.md` |
...
| `hybrid_rl_resac_ant` | `half_loaded/same_workload_half_capacity` | `node007-direct` | `node007-direct:gpu_busy` |
| `hybrid_rl_resac_ant` | `full_loaded/same_workload_to_capacity_boundary` | `node007-direct` | `node007-direct:gpu_busy` |
| `hybrid_rl_resac_halfcheetah` | `half_loaded/same_workload_half_capacity` | `node007-direct` | `node007-direct:gpu_busy` |
| `hybrid_rl_resac_halfcheetah` | `full_loaded/same_workload_to_capacity_boundary` | `node007-direct` | `node007-direct:gpu_busy` |
| `hybrid_rl_resac_hopper` | `half_loaded/same_workload_half_capacity` | `node007-direct` | `node007-direct:gpu_busy` |
| `hybrid_rl_resac_hopper` | `full_loaded/same_workload_to_capacity_boundary` | `node007-direct` | `node007-direct:gpu_busy` |
| `hybrid_rl_resac_walker2d` | `half_loaded/same_workload_half_capacity` | `node007-direct` | `node007-direct:gpu_busy` |
| `hybrid_rl_resac_walker2d` | `full_loaded/same_workload_to_capacity_boundary` | `node007-direct` | `node007-direct:gpu_busy` |