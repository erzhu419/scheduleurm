...
- ETA CSV: `md/experiment_artifacts/full_factorial_eta_design_rows_cpu_native_all_state_lcb_20260727.csv`
- Migration CSV: `md/experiment_artifacts/full_factorial_migration_design_rows_cpu_native_all_state_lcb_20260727.csv`
...
| `q10_high_cpu_low_gpu` | `freqduet_cpu_native` | `freqduet` | `colocation_count` | `[1, 2, 4]` | `native_cpu_colocation_completion_matrix` |
| `q10_high_cpu_low_gpu` | `sumo_eval_cpu` | `sumo` | `colocation_count` | `[1, 2, 4, 8, 16, 32, 64, 96, 128]` | `sumo_progress_or_surrogate` |
| `q10_high_cpu_low_gpu` | `sumo_eval_cpu_native` | `sumo` | `colocation_count` | `[1, 2, 4]` | `native_cpu_colocation_completion_matrix` |
...
| `controlled_colocation` | `none` | `native_colocation_nontrivial` | `required` |
