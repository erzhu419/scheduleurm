...
|---|---|---|---|---|---:|---:|---:|---|
| `gpu_3080ti_12gb_dual|q11_high_cpu_high_gpu|hybrid_rl_resac_ant|ant|empty|none` | `jtl110gpu` | `hybrid_rl_resac_ant` | `ant` | `empty` | `[3, 4, 5, 6]` | true | `[]` | `p3=0.54317, p4=0.541708, p5=0.542132, p6=0.541897` |
