...
- Artifact: `/home/erzhu419/mine_code/scheduleurm/md/experiment_artifacts/critical_gpu_completion_v7_jtl110gpu_r03_20260803.json`
...
| `gpu_cnn_torch_resnet50` | 3 | 6 | `FAILED` | False | False |
| `gpu_llm_distilgpt2` | 1 | 2 | `READY` | True | True |
| `gpu_llm_distilgpt2` | 3 | 6 | `READY` | True | True |
| `gpu_llm_distilgpt2` | 8 | 16 | `FAILED_EXCEPTION` | False | False |
