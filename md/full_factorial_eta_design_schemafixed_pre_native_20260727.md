...
- ETA CSV: `md/experiment_artifacts/full_factorial_eta_design_rows_schemafixed_pre_native_20260727.csv`
- Migration CSV: `md/experiment_artifacts/full_factorial_migration_design_rows_schemafixed_pre_native_20260727.csv`

## ETA Row Status

| Status | Rows |
|---|---:|
| `boundary_plus_pending_probe` | 16 |
| `measured` | 84 |
| `measured_to_capacity_boundary` | 8 |
