...
|---|---|---|---|---:|---:|---|
| `design_jtl311linux_gpu_cnn_torch_resnet50_cnn_high_vram_resident_llm_or_memory_resident_p3` | `jtl311linux` | `high_vram_resident` | `gpu_cnn_torch_resnet50` | 11.0084 | true | `` |
