...
- Artifact: `/home/erzhu419/mine_code/scheduleurm/md/experiment_artifacts/critical_gpu_completion_v7_jtl110gpu2_r03_20260803.json`
- Protocol: `critical_gpu_phase_completion_v7`
- Node: `jtl110gpu2`
- Wave / role: `3` / `training`
- Status: `INCOMPLETE`
- Ready rows: `7`
...
| `gpu_llm_distilgpt2` | 3 | 6 | `FAILED_EXCEPTION` | False | False |
| `gpu_llm_distilgpt2` | 8 | 16 | `READY` | True | True |
| `hybrid_rl_resac_ant` | 2 | 4 | `READY` | True | True |
| `hybrid_rl_resac_ant` | 5 | 10 | `FAILED_EXCEPTION` | False | False |
