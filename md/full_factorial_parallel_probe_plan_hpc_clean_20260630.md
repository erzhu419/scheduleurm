...
- Pending rows considered: `202`
- Selected rows: `0`
- Max rows per lane: `1`
- Availability audit: `/home/erzhu419/mine_code/scheduleurm/md/experiment_artifacts/resource_audit_hpc6_parallel_20260630/corner_case_resource_audit.json`
...
|---|---|---|---|
| `hybrid_rl_resac_ant` | `full_loaded/same_workload_to_capacity_boundary` | `jtl110gpu;jtl110gpu2` | `jtl110gpu:missing_audit;jtl110gpu2:missing_audit` |
| `hybrid_rl_resac_halfcheetah` | `full_loaded/same_workload_to_capacity_boundary` | `jtl110gpu;jtl110gpu2` | `jtl110gpu:missing_audit;jtl110gpu2:missing_audit` |
| `hybrid_rl_resac_hopper` | `full_loaded/same_workload_to_capacity_boundary` | `jtl110gpu;jtl110gpu2` | `jtl110gpu:missing_audit;jtl110gpu2:missing_audit` |
| `hybrid_rl_resac_walker2d` | `full_loaded/same_workload_to_capacity_boundary` | `jtl110gpu;jtl110gpu2` | `jtl110gpu:missing_audit;jtl110gpu2:missing_audit` |
| `hybrid_rl_bapr_ant` | `full_loaded/same_workload_to_capacity_boundary` | `jtl110gpu;jtl110gpu2` | `jtl110gpu:missing_audit;jtl110gpu2:missing_audit` |
| `light_control_local` | `full_loaded/same_workload_to_capacity_boundary` | `jtl311linux` | `jtl311linux:missing_audit` |
| `light_control_local` | `cpu_resident/cpu_worker_resident` | `jtl311linux` | `jtl311linux:missing_audit` |
| `cpu_heavy_local_bench` | `full_loaded/same_workload_to_capacity_boundary` | `jtl311linux` | `jtl311linux:missing_audit` |
| `cpu_heavy_local_bench` | `cpu_resident/cpu_worker_resident` | `jtl311linux` | `jtl311linux:missing_audit` |
| `freqduet_cpu_ablation_c17_32` | `full_loaded/same_workload_to_capacity_boundary` | `jtl311linux` | `jtl311linux:missing_audit` |
| `freqduet_cpu_ablation_c17_32` | `cpu_resident/cpu_worker_resident` | `jtl311linux` | `jtl311linux:missing_audit` |
| `sumo_eval_cpu` | `full_loaded/same_workload_to_capacity_boundary` | `jtl311linux` | `jtl311linux:missing_audit` |
| `sumo_eval_cpu` | `cpu_resident/cpu_worker_resident` | `jtl311linux` | `jtl311linux:missing_audit` |
| `hybrid_rl_resac_ant` | `half_loaded/same_workload_half_capacity` | `jtl311linux` | `jtl311linux:missing_audit` |
| `hybrid_rl_resac_ant` | `full_loaded/same_workload_to_capacity_boundary` | `jtl311linux` | `jtl311linux:missing_audit` |
| `hybrid_rl_resac_halfcheetah` | `half_loaded/same_workload_half_capacity` | `jtl311linux` | `jtl311linux:missing_audit` |
| `hybrid_rl_resac_halfcheetah` | `full_loaded/same_workload_to_capacity_boundary` | `jtl311linux` | `jtl311linux:missing_audit` |
| `hybrid_rl_resac_hopper` | `half_loaded/same_workload_half_capacity` | `jtl311linux` | `jtl311linux:missing_audit` |
| `hybrid_rl_resac_hopper` | `full_loaded/same_workload_to_capacity_boundary` | `jtl311linux` | `jtl311linux:missing_audit` |
| `hybrid_rl_resac_walker2d` | `half_loaded/same_workload_half_capacity` | `jtl311linux` | `jtl311linux:missing_audit` |
| `hybrid_rl_resac_walker2d` | `full_loaded/same_workload_to_capacity_boundary` | `jtl311linux` | `jtl311linux:missing_audit` |
| `hybrid_rl_bapr_ant` | `half_loaded/same_workload_half_capacity` | `jtl311linux` | `jtl311linux:missing_audit` |
| `hybrid_rl_bapr_ant` | `full_loaded/same_workload_to_capacity_boundary` | `jtl311linux` | `jtl311linux:missing_audit` |
| `hybrid_rl_resac_ant` | `half_loaded/same_workload_half_capacity` | `node007-direct` | `node007-direct:missing_audit` |
| `hybrid_rl_resac_ant` | `full_loaded/same_workload_to_capacity_boundary` | `node007-direct` | `node007-direct:missing_audit` |
| `hybrid_rl_resac_halfcheetah` | `half_loaded/same_workload_half_capacity` | `node007-direct` | `node007-direct:missing_audit` |
| `hybrid_rl_resac_halfcheetah` | `full_loaded/same_workload_to_capacity_boundary` | `node007-direct` | `node007-direct:missing_audit` |
| `hybrid_rl_resac_hopper` | `half_loaded/same_workload_half_capacity` | `node007-direct` | `node007-direct:missing_audit` |
| `hybrid_rl_resac_hopper` | `full_loaded/same_workload_to_capacity_boundary` | `node007-direct` | `node007-direct:missing_audit` |
| `hybrid_rl_resac_walker2d` | `half_loaded/same_workload_half_capacity` | `node007-direct` | `node007-direct:missing_audit` |
| `hybrid_rl_resac_walker2d` | `full_loaded/same_workload_to_capacity_boundary` | `node007-direct` | `node007-direct:missing_audit` |
| `light_control_local` | `cpu_resident/cpu_worker_resident` | `jtl110cpu;jtl110cpu2;node007-direct` | `jtl110cpu:missing_audit;jtl110cpu2:missing_audit;node007-direct:missing_audit` |
| `cpu_heavy_local_bench` | `cpu_resident/cpu_worker_resident` | `jtl110cpu;jtl110cpu2;node007-direct` | `jtl110cpu:missing_audit;jtl110cpu2:missing_audit;node007-direct:missing_audit` |
| `freqduet_cpu_ablation_c17_32` | `cpu_resident/cpu_worker_resident` | `jtl110cpu;jtl110cpu2;node007-direct` | `jtl110cpu:missing_audit;jtl110cpu2:missing_audit;node007-direct:missing_audit` |
| `sumo_eval_cpu` | `cpu_resident/cpu_worker_resident` | `jtl110cpu;jtl110cpu2;node007-direct` | `jtl110cpu:missing_audit;jtl110cpu2:missing_audit;node007-direct:missing_audit` |