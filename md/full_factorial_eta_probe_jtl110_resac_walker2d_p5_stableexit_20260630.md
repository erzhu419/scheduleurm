...
|---|---|---|---|---|---:|---:|---:|---|
| `gpu_3080ti_12gb_dual|q11_high_cpu_high_gpu|hybrid_rl_resac_walker2d|walker2d|empty|none` | `jtl110gpu` | `hybrid_rl_resac_walker2d` | `walker2d` | `empty` | `[5]` | true | `[]` | `p5=1.1089` |
