...
| Candidate-family expansion cannot worsen a certified support gap | `<LEAN_PROOF_SOURCE>/Scheduleurm/ActionUnion.lean` | `support_gap_mono_under_candidate_expansion` |
| Candidate-family expansion preserves the base support-loss capacity margin \(\delta-\epsilon\) | `<LEAN_PROOF_SOURCE>/Scheduleurm/ActionUnion.lean` | `candidate_capacity_slack_loss_under_expansion` |
