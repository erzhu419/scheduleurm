...
|---|---|---:|---:|---:|:---:|
| `cnn_after_llm` | `gpu_llm_distilgpt2` -> `gpu_cnn_torch_resnet50` | 15.4473 | 242.481 | 3.88417 | true |
| `cnn_after_rl` | `hybrid_rl_resac_ant` -> `gpu_cnn_torch_resnet50` | 15.8614 | 0.104614 | 3.78276 | true |
| `llm_after_cnn` | `gpu_cnn_torch_resnet50` -> `gpu_llm_distilgpt2` | 14.0809 | 20.4239 | 8.52217 | true |
| `rl_after_cnn` | `gpu_cnn_torch_resnet50` -> `hybrid_rl_resac_ant` | 775.021 | 16.2057 | 0.0516115 | true |
