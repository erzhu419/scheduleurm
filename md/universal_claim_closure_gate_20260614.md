...
Named same-host same-workload SOTA gates, measured/admitted future workload protocol, conservative deployment/fabric boundaries, registered-SOTA policy/service-unit adapter closure, Decima same-domain Spark-DAG execution audit, and production organic history/recorder gate.
