...
representative GPU hardware gates must be PASS under the v3 measurement
...
def default_gate_paths(
    *, artifact_root: Path = ARTIFACT_ROOT
    ...
    return {
        ...
        / f"critical_gpu_stochastic_lcb_gate_v3_{node}_{CAMPAIGN_DATE}.json"
    ...
    *,
    ...
    common = {
        ...
        "claim_boundary": (
            ...
            "jtl311linux each provide a hardware-local v3 PASS certificate for "
