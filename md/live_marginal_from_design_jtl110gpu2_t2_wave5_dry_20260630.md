...
|---|---|---|---|---:|---:|---|
| `design_jtl110gpu2_gpu_heavy_jax_matmul_gpu_matmul_mixed_colocation_cnn_plus_llm_p1` | `jtl110gpu2` | `mixed_colocation` | `gpu_heavy_jax_matmul` | 0 | false | `dry_run_manifest` |
