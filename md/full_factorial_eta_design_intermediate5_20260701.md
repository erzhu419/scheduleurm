...
- ETA CSV: `md/experiment_artifacts/full_factorial_eta_design_rows_intermediate5_20260701.csv`
- Migration CSV: `md/experiment_artifacts/full_factorial_migration_design_rows_intermediate5_20260701.csv`
...
|---|---:|
| `measured` | 91 |
| `measured_to_capacity_boundary` | 23 |
| `partial_pending_probe` | 2 |
| `pending_probe` | 172 |
...
| `gpu_node007_4x11gb` | `node007-direct` | `` | Four homogeneous RTX 2080 Ti GPUs; bucket name is historical, live memory is about 11GB. |
...
| Quadrant | Workload | Env | Profiles | Runner |
|---|---|---|---:|---|
| `q00_low_cpu_low_gpu` | `light_control_local` | `light` | `[1, 2, 4, 8, 13, 14]` | `light_progress_control` |
| `q01_low_cpu_high_gpu` | `gpu_cnn_torch_resnet50` | `cnn` | `[1, 2, 3, 4, 5, 6, 8]` | `torch_cnn_resnet50.cmd.tpl` |
| `q01_low_cpu_high_gpu` | `gpu_llm_distilgpt2` | `llm` | `[1, 2, 3, 4]` | `torch_llm_distilgpt2.cmd.tpl` |
| `q01_low_cpu_high_gpu` | `gpu_heavy_jax_matmul` | `gpu_matmul` | `[1, 2, 3, 4, 5, 6, 8]` | `jax_matmul_progress` |
| `q10_high_cpu_low_gpu` | `cpu_heavy_local_bench` | `cpu` | `[1, 2, 4, 8, 16, 32, 64, 96, 128, 180, 192]` | `cpu_parallel_progress_benchmark` |
| `q10_high_cpu_low_gpu` | `freqduet_cpu_ablation_c17_32` | `freqduet` | `[1, 2, 4, 8, 16, 32, 64, 96, 128, 180, 192]` | `freqduet_or_checkpointable_surrogate` |
| `q10_high_cpu_low_gpu` | `sumo_eval_cpu` | `sumo` | `[1, 2, 4, 8, 16, 32, 64, 96, 128]` | `sumo_progress_or_surrogate` |
| `q11_high_cpu_high_gpu` | `hybrid_rl_resac_ant` | `ant` | `[1, 2, 3, 4, 5, 6]` | `resac_env_real_venv.cmd.tpl` |
| `q11_high_cpu_high_gpu` | `hybrid_rl_resac_halfcheetah` | `halfcheetah` | `[1, 2, 3, 4, 5, 6]` | `resac_env_real_venv.cmd.tpl` |
| `q11_high_cpu_high_gpu` | `hybrid_rl_resac_hopper` | `hopper` | `[1, 2, 3, 4, 5, 6]` | `resac_env_real_venv.cmd.tpl` |
| `q11_high_cpu_high_gpu` | `hybrid_rl_resac_walker2d` | `walker2d` | `[1, 2, 3, 4, 5, 6]` | `resac_env_real_venv.cmd.tpl` |
| `q11_high_cpu_high_gpu` | `hybrid_rl_bapr_ant` | `bapr_ant` | `[1, 2, 3, 4, 5, 6]` | `bapr_ant_real.cmd.tpl` |
