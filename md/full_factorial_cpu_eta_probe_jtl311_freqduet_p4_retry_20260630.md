...
|---|---|---|---|---|---:|---:|---|
| `gpu_rtx2080_8gb_dual_cpu_fast|q10_high_cpu_low_gpu|freqduet_cpu_ablation_c17_32|freqduet|empty|none` | `jtl311linux` | `freqduet_cpu_ablation_c17_32` | `freqduet` | `empty` | `[4]` | true | `p4=41.1988` |
