...
- Artifact: `/home/erzhu419/mine_code/scheduleurm/md/experiment_artifacts/critical_gpu_completion_v8_jtl311linux_r05_20260803.json`
- Protocol: `critical_gpu_phase_completion_v8`
- Node: `jtl311linux`
- Wave / role: `5` / `calibration`
- Status: `PASS`
- Ready rows: `8`
- Capacity boundaries: `1`
...
| `gpu_cnn_torch_resnet50` | 2 | 4 | `CAPACITY_BOUNDARY` | False | True |
