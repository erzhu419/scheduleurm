...
GATES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "scoped_claim": "Scheduleurm can evaluate a candidate set that explicitly contains SOTA-style policy-family actions and beat the metric-specific SOTA envelopes on the measured service cache.",
        "scoped_key": "scoped_claim_ready",
        "strong_claim": "A single scalar objective simultaneously dominates every external full-stack system on every metric.",
        "strong_key": "strong_claim_ready",
        "blocker": "Metric-specific makespan and mean-flow envelopes are closed; a single guarded objective still exposes a q01 makespan/flow tradeoff and is not an external binary run.",
        "next_threshold": "Keep SOTA policy-family union as the main theory-facing dominance claim; promote direct-system language only after full-stack same-workload execution.",
    },
    {
