...
|---|---|---|---|---|---:|---:|---:|---|
| `gpu_node007_4x11gb|q11_high_cpu_high_gpu|hybrid_rl_bapr_ant|bapr_ant|empty|none` | `node007-direct` | `hybrid_rl_bapr_ant` | `bapr_ant` | `empty` | `[5]` | false | `[5]` | `p5=0.546718` |
