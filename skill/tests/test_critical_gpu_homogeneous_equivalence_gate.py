...
def test_default_paths_use_exact_formal_v3_matched_wave_names(tmp_path):
    representative, equivalent = default_artifact_paths(artifact_root=tmp_path)

    assert representative.name == "critical_gpu_completion_v3_jtl110gpu_r01_20260803.json"
    assert equivalent.name == "critical_gpu_completion_v3_jtl110gpu2_r01_20260803.json"
