...
|---|---|---|---|---|---:|---:|---:|---|
| `gpu_node007_4x11gb|q11_high_cpu_high_gpu|hybrid_rl_resac_halfcheetah|halfcheetah|empty|none` | `node007-direct` | `hybrid_rl_resac_halfcheetah` | `halfcheetah` | `empty` | `[2]` | true | `[]` | `p2=0.484983` |
