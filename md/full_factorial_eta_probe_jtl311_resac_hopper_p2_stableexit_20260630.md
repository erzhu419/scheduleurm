...
|---|---|---|---|---|---:|---:|---:|---|
| `gpu_rtx2080_8gb_dual_cpu_fast|q11_high_cpu_high_gpu|hybrid_rl_resac_hopper|hopper|empty|none` | `jtl311linux` | `hybrid_rl_resac_hopper` | `hopper` | `empty` | `[2]` | true | `[]` | `p2=0.594062` |
