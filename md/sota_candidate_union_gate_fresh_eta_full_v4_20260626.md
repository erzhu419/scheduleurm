...
|---|---|---|---:|---:|---:|---:|
| `legacy_fixed_caps` | `legacy` |  | 341169 | 16137.1 | 2.29085 | 5.15633 |
| `scheduleurm_sota_union_adaptive_scalarized` | `candidate_union` | Gavel, Pollux, Sia, IADeep, Salus, SRPT, Gittins | 148962 | 3129.38 | 1.00023 | 0.999937 |
| `scheduleurm_sota_union_guarded_mean_flow` | `candidate_union` | Gavel, Pollux, Sia, IADeep, Salus, SRPT, Gittins | 149591 | 3129.76 | 1.00446 | 1.00006 |
| `scheduleurm_sota_union_makespan` | `candidate_union` | Gavel, Pollux, Sia, IADeep, Salus, SRPT, Gittins | 148962 | 3129.38 | 1.00024 | 0.999936 |
| `scheduleurm_sota_union_mean_flow` | `candidate_union` | Gavel, Pollux, Sia, IADeep, Salus, SRPT, Gittins | 149555 | 3129.95 | 1.00422 | 1.00012 |
| `scheduleurm_sota_union_online_pareto_slack` | `candidate` |  | 148927 | 3129.58 | 1 | 1 |
...
| `sota_gavel_pollux_sia_table_goodput` | `sota_style` | Gavel, Pollux, Sia, Optimus, AlloX | 149940 | 3130.51 | 1.0068 | 1.0003 |
| `sota_iadeep_salus_interference_guard` | `sota_style` | IADeep, Salus | 150665 | 3132.94 | 1.01167 | 1.00107 |
| `sota_quadrant_composite` | `sota_style` | Gavel/Pollux/Sia, IADeep/Salus, SRPT/Gittins, Tiresias-style LAS, AlloX/Optimus resource adaptation | 149940 | 3130.51 | 1.0068 | 1.0003 |
| `sota_salus_iadeep_packing_guard` | `sota_style` | Salus, IADeep, Gandiva, AlloX | 148930 | 3129.58 | 1.00002 | 1 |
| `sota_sia_pollux_resource_adaptive` | `sota_style` | Sia, Pollux, Optimus, AlloX | 148927 | 3129.57 | 0.999999 | 0.999997 |
