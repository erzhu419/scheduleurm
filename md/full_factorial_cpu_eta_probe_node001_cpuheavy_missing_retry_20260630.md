...
|---|---|---|---|---|---:|---:|---|
| `cpu_hpc_192c|q10_high_cpu_low_gpu|cpu_heavy_local_bench|cpu|empty|none` | `node001` | `cpu_heavy_local_bench` | `cpu` | `empty` | `[2, 32, 64, 180]` | false | `p2=0, p32=0, p64=10.1971, p180=6.13705` |
