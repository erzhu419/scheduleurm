...
|---|---|---|---|---|---:|---:|---:|---|
| `gpu_rtx2080_8gb_dual_cpu_fast|q11_high_cpu_high_gpu|hybrid_rl_bapr_ant|bapr_ant|empty|none` | `jtl311linux` | `hybrid_rl_bapr_ant` | `bapr_ant` | `empty` | `[4]` | true | `[]` | `p4=0.409677` |
