...
REQUIRED_MANUSCRIPT_TOKENS = (
    ...
    r"\UnifiedSotaPolicyTraceComparisonCount",
    r"\UnifiedSotaDominatesOursCount",
    r"\UnifiedSotaAggregateBothMetricWinCount",
    r"\UnifiedSotaQZeroZeroDominanceCount",
    r"\UnifiedSotaQZeroOneDominanceCount",
    r"\UnifiedSotaQOneZeroDominanceCount",
    r"\UnifiedSotaQOneOneDominanceCount",
