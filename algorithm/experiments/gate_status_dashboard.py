...
GATES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "next_threshold": "Keep service-cache timestamp/sample-window metadata synchronized; perturbation profiling is needed only for a broader state universe.",
    },
    {
    ...
    },
    {
        ...
        "scoped_claim": "Named same-host same-workload external runtime probes for Gavel, Pollux/AdaptDL, Sia, IADeep, and Salus, each with a paired native-better row on the measured probe.",
        "scoped_key": "named_same_host_runtime_probe_ready",
        "strong_claim": "Direct full-stack SOTA superiority over named, registered, arbitrary, future, original multi-node, or production-wide settings.",
        "strong_key": "direct_fullstack_sota_superiority_ready",
        "blocker": "The named runtime probes are closed, but direct full-stack SOTA superiority remains false by construction.",
        "next_threshold": "Use only runtime-probe or policy-semantics language unless every external system is rerun under a common deployment, workload, and metric contract.",
    },
    {
        ...
        "scoped_claim": "Named runtime-probe evidence is separated from additional registered SOTA systems inventoried as pending.",
        "scoped_key": "named_five_runtime_probe_ready",
        "strong_claim": "Registered SOTA-universe or arbitrary SOTA superiority.",
        "strong_key": "registered_sota_universe_superiority_ready",
        "blocker": "Tiresias, Themis, Gandiva, Shockwave, AlloX, Optimus, and any new SOTA system still need comparable adapter rows before universe-level language.",
        "next_threshold": "Add comparable policy or runtime-probe rows for each registered system, then rerun the registry gate; arbitrary unbounded SOTA remains a non-finite claim.",
    },
    {
        ...
        "scoped_key": "scoped_claim_ready",
        "strong_claim": "Registered extension systems have runnable same-workload runtime-probe rows.",
        ...
        "next_threshold": "Close entrypoint smoke and same-workload runtime-probe rows one registered system at a time.",
    },
    {
        ...
        "strong_claim": "External-binary superiority over every registered or arbitrary SOTA system.",
        "strong_key": "registered_sota_universe_superiority_ready",
        "blocker": "Policy-semantics admitted-action superiority is closed; external binary superiority still needs same-service-unit adapters for registered systems without direct rows.",
        "next_threshold": "Use admitted-action language for the theory-facing SOTA universe; use direct-system language only for systems with same-workload runtime-probe rows.",
    },
    {
    ...
    },
    {
        ...
        "scoped_claim": "Same-host named runtime-probe evidence and Scheduleurm-native multi-node history are separated from external SOTA original-deployment claims.",
    ...
    },
    {
        ...
        "strong_claim": "Controlled 32-task launched-completion evidence only; strict-history and live-trace production completion are separate rows.",
        "strong_key": "controlled_completion_strong_claim_ready",
        "blocker": "Controlled completion is closed; this row does not promote live-oracle or production-history completion.",
    ...
    },
    {
        ...
        "strong_claim": "Organic live-trace launched-completion evidence from canary counters.",
        "strong_key": "live_trace_large_scale_organic_completion_ready",
        "blocker": "The canary recorder is ready, but the live-trace completion counters remain separate from the strict-history certificate.",
        "next_threshold": "Collect enough live oracle trace launches/completions, domains, nodes, and zero unadmitted launched rows.",
    },
    {
        ...
        "scoped_key": "history_large_scale_organic_completion_ready",
        "strong_claim": "Strict scheduler-history organic launched/completion evidence for the theorem-facing population.",
        "strong_key": "history_large_scale_organic_completion_ready",
    ...
    },
    {
        ...
        "scoped_key": "organic_production_canary_recorder_ready",
        "strong_claim": "History-backed large-scale completion evidence, with live-trace closure reported separately.",
        "strong_key": "history_large_scale_organic_completion_ready",
        "blocker": "This row is history-backed completion evidence; live oracle trace closure is reported in a separate subgate.",
        "next_threshold": "Keep history-completion and live-oracle-trace subclaims separate in manuscript wording.",
    },
    {
        "gate": "production_wide_live_oracle_trace_subgate",
        "artifact": "md/experiment_artifacts/production_wide_organic_trace_gate_20260614.json",
        "raw": "md/production_wide_organic_trace_gate_20260614.md",
        "scoped_claim": "Queued-production live-trace gate is executable or waiting without unsafe launch.",
        "scoped_key": "queued_live_trace_gate_ready_or_wait",
        "strong_claim": "Production-wide live oracle trace is closed with enough admitted theorem dispatch slots and completion evidence.",
        "strong_key": "production_wide_live_trace_closed",
        "blocker": "The current package closes production history, not a large-scale live oracle trace; the latest live trace status is a WAIT/readonly subclaim.",
        "next_threshold": "Collect a naturally accumulated admitted live oracle trace with enough slots, realized progress/completions, and zero unadmitted launched rows.",
    },
    {
        ...
        "strong_claim": "Combined large-scale completion evidence, with history and live-trace paths exposed by subfields.",
        "strong_key": "combined_large_scale_completion_evidence_ready",
    ...
    },
    {
        ...
        "strong_claim": "Strict scheduler-history large-scale launched/completion certificate.",
        "strong_key": "strict_history_large_scale_completion_ready",
        "blocker": "The gate's live-oracle-traced large-scale completion flag remains separate and false unless an admitted live trace closes.",
        "next_threshold": "Use the strict-history certificate for completed production evidence; use live-oracle language only after live_oracle_traced_large_scale_completion_ready becomes true.",
    },
    {
    ...
    },
    {
        ...
        "strong_claim": "All non-future scoped closures imply unbounded external-binary or universal coverage.",
        "strong_key": "strong_claim_ready",
