...
|---|---|---|---|---|---:|---:|---|
| `cpu_hpc_192c|q10_high_cpu_low_gpu|freqduet_cpu_ablation_c17_32|freqduet|empty|none` | `node001` | `freqduet_cpu_ablation_c17_32` | `freqduet` | `empty` | `[2, 128, 192]` | false | `p2=0, p128=5.7028, p192=4.59428` |
