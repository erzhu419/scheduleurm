...
|---|---|---|---|---|---:|---:|---:|---|
| `gpu_3080ti_12gb_dual|q11_high_cpu_high_gpu|hybrid_rl_resac_hopper|hopper|empty|none` | `jtl110gpu` | `hybrid_rl_resac_hopper` | `hopper` | `empty` | `[2, 3, 4, 5, 6]` | true | `[]` | `p2=0.884973, p3=0.880668, p4=0.882323, p5=0.882534, p6=0.879042` |
