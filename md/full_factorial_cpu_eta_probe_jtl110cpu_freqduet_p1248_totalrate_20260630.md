...
|---|---|---|---|---|---:|---:|---|
| `cpu_jtl110_128c|q10_high_cpu_low_gpu|freqduet_cpu_ablation_c17_32|freqduet|empty|none` | `jtl110cpu` | `freqduet_cpu_ablation_c17_32` | `freqduet` | `empty` | `[1, 2, 4, 8]` | true | `p1=22.1863, p2=21.4289, p4=20.2009, p8=18.265` |
