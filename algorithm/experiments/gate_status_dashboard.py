...
GATES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "next_threshold": "Use only runtime-probe or policy-semantics language unless every external system is rerun under a common full-stack deployment and metric contract.",
    },
    {
