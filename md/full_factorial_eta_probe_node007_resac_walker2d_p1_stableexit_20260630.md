...
|---|---|---|---|---|---:|---:|---:|---|
| `gpu_node007_4x11gb|q11_high_cpu_high_gpu|hybrid_rl_resac_walker2d|walker2d|empty|none` | `node007-direct` | `hybrid_rl_resac_walker2d` | `walker2d` | `empty` | `[1]` | true | `[]` | `p1=1.55663` |
